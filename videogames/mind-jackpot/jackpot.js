(function(){
  "use strict";
  var VERSION="mind-jackpot-1.1.0",ROUNDS=60,SYMBOL_COUNT=6,CURRENT_KEY="mind_jackpot_current_v1",DB_NAME="mind-jackpot-research",DB_STORE="sessions";
  ...
  var session=null,roundIndex=0,picks=[],confidence=50,roundStarted=0,locked=false,audioOn=true,audioContext=null,timers=[],intervals=[],syncInFlight=false,syncPending=false;
  ...
  function resumeSaved(){var saved=loadCurrent();if(!saved)return;session=saved;ensureSyncToken();syncSession("local_session_resumed");if(session.status==="committed"){prepareReady();return;}resume();}
